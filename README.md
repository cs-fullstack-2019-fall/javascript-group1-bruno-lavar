...
Score : 1 point
You don't have a main.js file to call funcions from your individual files and only the work from person one is included in the index.html file. see index.js for more comments
